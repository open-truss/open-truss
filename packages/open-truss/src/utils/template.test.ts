import { StringOrTemplate, resolveStringOrTemplate, resolveTemplate } from './template'
...
test('resolveStringOrTemplate', () => {
  ...
  expect(resolveStringOrTemplate(StringOrTemplate.parse(signal('hello')))).toBe('hello')
})
